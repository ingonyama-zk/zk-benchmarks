...
INSERT INTO multiply_benchmark (project, test_timestamp, git_id, frequency_MHz, vector_size, batch_size, runtime_sec, power_Watt, chip_temp_C, comment, runs_on, uses)
VALUES (
  '$project',
  '$test_timestamp',
  '$git_id',
