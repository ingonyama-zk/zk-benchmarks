...
echo "Throughput (GiB/sec): $throughput_GiB_sec"
...
INSERT INTO grostl_benchmark (project, test_timestamp, git_id, frequency_MHz, batch_size, msg_size, runtime_sec, throughput_GiB_sec, power_Watt, chip_temp_C, comment, runs_on)
VALUES (
  '$project',
  '$test_timestamp',
  '$git_id',
