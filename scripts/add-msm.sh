...
echo "GitID: $git_id"
echo "Frequency (MHz): $frequency_MHz"
echo "Vector size: $vector_size"
echo "Coefficient C: $coefficient_C"
...
# Execute the psql command to insert the row into the msm_benchmark table
PGPASSWORD=$DB_PASS psql -h $DB_HOST -p $DB_PORT -U $DB_USER -d $DB_NAME -c "
INSERT INTO msm_benchmark (project, test_timestamp, git_id, frequency_MHz, vector_size, coefficient_C, batch_size, runtime_sec, power_Watt, chip_temp_C, comment, runs_on, uses)
VALUES (
  '$project',
  '$test_timestamp',
  '$git_id',
